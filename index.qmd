...
::: {style="display:flex; gap:0.7em; align-items:flex-start; margin-bottom:0.5em;"}
<img src="assets/rosenblatt_journal.png" style="border-radius:6px; border:1px solid #22d3ee; width:105px; flex-shrink:0;">
<img src="assets/bio_neuron.png" style="border-radius:6px; border:1px solid rgba(34,211,238,0.3); width:calc(100% - 115px);">
:::
...
Inspired by McCulloch-Pitts neurons (1943) and Hebbian learning. One neuron, one decision boundary.
...
<img src="assets/artificial_neuron.png" style="width:100%; margin-top:0.5em; border-radius:6px; border:1px solid rgba(34,211,238,0.3);">
...
<img src="assets/dl_timeline.png" style="width:100%; margin-top:0.6em; border-radius:6px; border:1px solid rgba(34,211,238,0.2);">
...
<img src="assets/hopfield_to_rbm.png" style="width:100%; margin-top:0.5em; border-radius:6px; border:1px solid rgba(34,211,238,0.2);">

:::

::: {.col-right}

::: {style="display:flex; gap:0.6em; justify-content:center; margin-bottom:0.5em;"}
<figure style="text-align:center; margin:0;">
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/John_Hopfield_2009.jpg/120px-John_Hopfield_2009.jpg" style="border-radius:6px; border:1px solid #22d3ee; height:90px;">
<figcaption style="font-size:0.55em; color:#94a3b8; margin-top:0.2em;">J. Hopfield</figcaption>
</figure>
<figure style="text-align:center; margin:0;">
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Geoffrey_Hinton_at_UBC.jpg/120px-Geoffrey_Hinton_at_UBC.jpg" style="border-radius:6px; border:1px solid #22d3ee; height:90px;">
<figcaption style="font-size:0.55em; color:#94a3b8; margin-top:0.2em;">G. Hinton</figcaption>
</figure>
:::
...
::: {.col-left style="font-size: 0.6em;"}

| Year | Facility | AI approach | Impact |
|------|----------|-------------|--------|
| 1993 | CERN LEP | Neural network orbit correction | First ML in live operation |
| 2016 | Community | Edelen survey — 50+ ML papers | Revival of interest across labs |
| 2018 | SLAC LCLS | Bayesian optimisation in production | −10% beam loss, ~50 evaluations |
| 2019 | JLab CEBAF | Autoencoder on SRF IQ waveforms | Fault detection — no labels needed |
| 2021 | SLAC LCLS-II | Cheetah differentiable simulator | 10³–10⁵× faster than tracking codes |
| 2022 | ESRF, SNS | RL for orbit/tune correction | Autonomous closed-loop control |
| 2024 | KIT KARA | AI energy management | **−30% energy footprint** |
| 2026 | 19 institutions | TwinRISE digital twin programme | Production twins for proton therapy |

:::

::: {.col-right}

<img src="assets/publication_trend.png" style="width:100%; border-radius:6px; border:1px solid rgba(34,211,238,0.2);">

::: {style="font-size:0.65em; color:#94a3b8; margin-top:0.3em; text-align:center;"}
Publications on AI for particle accelerators — exponential rise since 2021
:::
...
::: notes
30 years from first NNs to production AI systems. The key inflection point is 2019: BO in production at LCLS (Duris+2020), RL at ESRF (Leemann+2019), differentiable simulation with Cheetah (Kaiser+2024). KARA result is not a simulation — measured on the real machine.
:::
...
<a href="https://github.com/aghribi/acc-ml-living-review" style="position:absolute; top:0.6em; right:1em; color:#22d3ee; line-height:1;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" style="width:1.3em;height:1.3em;fill:#22d3ee;vertical-align:middle;"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"/></svg></a>
...
::: {.fragment .fade-in}
::: {.highlight-box #box-fault style="margin: 0.25em 0; padding: 0.4em 0.8em;"}
**Fault detection** — classify anomalous events before interlocks trigger
:::
:::
::: {.fragment .fade-in}
::: {.highlight-box #box-tuning style="margin: 0.25em 0; padding: 0.4em 0.8em;"}
**Beam tuning** — find optimal settings with minimal beam time (< 50 evaluations)
:::
:::
::: {.fragment .fade-in}
::: {.highlight-box #box-surrogate style="margin: 0.25em 0; padding: 0.4em 0.8em;"}
...
# ML Foundations {.section-divider background-color="#0a1520"}
...
Raw signals from real machines are **noisy, unbalanced, and incomplete**.

::: {.highlight-box style="margin: 0.4em 0; padding: 0.4em 0.7em;"}
**Cleaning** — remove corrupted pulses, outliers, sensor dropouts
:::

::: {.highlight-box style="margin: 0.4em 0; padding: 0.4em 0.7em;"}
**Synchronisation** — align timestamps across subsystems
:::

::: {.highlight-box style="margin: 0.4em 0; padding: 0.4em 0.7em;"}
**Normalisation** — zero-mean / unit-variance; prevents gradient dominance
:::

::: {.highlight-box style="margin: 0.4em 0; padding: 0.4em 0.7em;"}
**Class balance** — SRF faults are < 0.1% of pulses; naive training ignores them
:::
...
<img src="assets/beam_images_raw.png" style="width:100%; border-radius:6px; border:1px solid rgba(34,211,238,0.2);">

::: {style="font-size:0.6em; color:#94a3b8; text-align:center; margin-bottom:0.4em;"}
Beam profile at two positions — raw pixel-level photon maps
:::

<img src="assets/srf_fault_counts.png" style="width:100%; border-radius:6px; border:1px solid rgba(34,211,238,0.2); margin-top:0.2em;">

::: {style="font-size:0.6em; color:#94a3b8; text-align:center;"}
SRF fault type distribution — severe class imbalance is the norm
:::
...
Raw data is often too high-dimensional for direct input:

- **1 024-point IQ waveform** → 3 scalar features (amplitude, phase, asymmetry)
- **512 × 512 beam image** → Gaussian fit: σ_x, σ_y, centroid (x, y)
- **Cavity signals** → FFT coefficients capturing specific frequency modes

::: {.highlight-box style="margin: 0.5em 0; padding: 0.4em 0.7em;"}
**Manual features**: interpretable, fast, need domain expertise
:::

::: {.highlight-box style="margin: 0.4em 0; padding: 0.4em 0.7em;"}
**Learned features**: CNNs / autoencoders — data-driven, may outperform hand-crafted
:::
...
<img src="assets/feature_pipeline.png" style="width:100%; border-radius:6px; border:1px solid rgba(34,211,238,0.2);">

::: {style="font-size:0.6em; color:#94a3b8; text-align:center; margin-bottom:0.4em;"}
Feature Pipeline → Training Pipeline → Inference Pipeline share a Feature Store
:::

<img src="assets/feature_heatmap.png" style="width:100%; border-radius:6px; border:1px solid rgba(34,211,238,0.2); margin-top:0.3em;">

::: {style="font-size:0.6em; color:#94a3b8; text-align:center;"}
Standard deviation of cavity signals across cryomodules — large variability motivates per-module normalisation
:::
...
::: {.col-left style="font-size:0.8em;"}

| Question | Points towards |
|----------|---------------|
| Do I have labels? | Supervised classification / regression |
| No labels, only normal data | Anomaly detection (autoencoder, VAE) |
| < 100 machine evaluations | Bayesian optimisation |
| Need sub-ms inference | Neural network surrogate |
| Online closed-loop control | Reinforcement learning |
| Need interpretability | Linear model, decision tree |
| Large dataset, high-dim input | Deep learning (CNN, Transformer) |

::: {.key-result style="margin-top: 0.5em;"}
No single method wins everywhere — match the tool to the constraint.
:::
...
<img src="assets/bo_acquisition_compare.png" style="width:100%; border-radius:6px; border:1px solid rgba(34,211,238,0.2);">

::: {style="font-size:0.62em; color:#94a3b8; text-align:center; margin-top:0.3em;"}
Same problem, same algorithm — different acquisition parameter β changes exploration/exploitation balance entirely. Method choice matters at every level.
:::
...
<img src="assets/ml_pipeline_full.png" style="width:100%; border-radius:6px; border:1px solid rgba(34,211,238,0.2); margin-bottom:0.5em;">

::: {style="display:flex; gap:0.6em; margin-top:0.3em; font-size:0.7em;"}

::: {.highlight-box style="flex:1; padding:0.4em 0.6em;"}
**UC1 · Fault detection**
IQ waveforms → normalise → autoencoder → reconstruction error → anomaly score
:::

::: {.highlight-box style="flex:1; padding:0.4em 0.6em;"}
**UC2 · Beam tuning**
Quad settings → Cheetah sim → BO acquisition → propose next setting → evaluate
:::

::: {.highlight-box style="flex:1; padding:0.4em 0.6em;"}
**UC3 · Surrogate model**
5 000 Cheetah samples → normalise → MLP training → sub-ms inference
:::

:::

::: notes
The pipeline diagram is from an EU research project but the structure is universal: data acquisition → feature engineering → model selection → training → validation → deployment → monitoring. Each use case in this lecture follows exactly this sequence.
:::
