...
::: {.highlight-box style="margin-bottom:0.2em; font-size:0.75em;"}
**① Intuition — ball rolling into a valley**

Memories are stored as **energy minima** (blue wells).
Give a noisy or incomplete input → the network rolls
downhill step by step → arrives at the nearest stored pattern.
:::

::: {.highlight-box style="margin-bottom:0.2em; font-size:0.75em;"}
**② Mechanism — spin-by-spin update**

$s_i \leftarrow \text{sign}(\sum_j w_{ij} s_j)$

Energy decreases at every step: **guaranteed convergence**.
Weights $w_{ij} = \frac{1}{N}\sum_\mu \xi_i^\mu \xi_j^\mu$ encode the memories.
:::

::: {.key-result .fragment style="font-size:0.75em; margin:0.2em 0;"}
**③ Limit — capacity ≈ 0.14 N patterns**

N neurons → at most ~0.14N memories stored cleanly.
Beyond this threshold retrieval fails **catastrophically**
(a sharp phase transition, not a gradual degradation).
:::
...
::: {.fragment .highlight-box style="font-size:0.78em; margin-bottom:0.28em;"}
**Foundation models** — large pretrained nets fine-tuned per facility; cross-machine transfer without retraining.
:::

::: {.fragment .highlight-box style="font-size:0.78em; margin-bottom:0.28em;"}
**PINNs** — beam dynamics equations embedded in the loss; physics constraints hold far from training data.
:::

::: {.fragment .highlight-box style="font-size:0.78em; margin-bottom:0.28em;"}
**Transformers** — attention on beam time-series; handles non-stationary, correlated signals.
:::

::: {.fragment .highlight-box style="font-size:0.78em; margin-bottom:0.28em;"}
**Reinforcement learning** — closed-loop policy; live at ESRF, SNS, proton therapy facilities.
:::

::: {.fragment .highlight-box style="font-size:0.78em; margin-bottom:0;"}
**Generative models** — VAEs / diffusion synthesise fault waveforms; solves clinical-machine data scarcity.
:::
...
::: {style="display:flex; gap:0.55em; margin-top:0.3em;"}
::: {.highlight-box style="flex:1; font-size:0.80em; padding:0.55em 0.75em; margin:0;"}
**RAISE** — Resource for AI Science in Europe

€107 M Horizon Europe pilot · launched Nov 2025
Virtual institute — "CERN for AI" · 19 partner countries

<a href="https://research-and-innovation.ec.europa.eu/strategy/strategy-research-and-innovation/our-digital-future/european-ai-science-strategy/raise-resource-ai-science-europe_en" style="color:#22d3ee; font-size:0.88em;">research-and-innovation.ec.europa.eu → RAISE</a>
:::

::: {.highlight-box style="flex:1; font-size:0.80em; padding:0.55em 0.75em; margin:0;"}
**GENESIS Mission** — US Dept. of Energy

$293 M for AI × national science challenges
17 DOE national laboratories · launched Nov 2025

<a href="https://www.energy.gov/undersecretaryforscience/genesis-mission/genesis-mission" style="color:#22d3ee; font-size:0.88em;">energy.gov → Genesis Mission</a>
:::
:::

::: {style="display:flex; gap:0.55em; margin-top:0.55em;"}
::: {.highlight-box style="flex:1; font-size:0.80em; padding:0.55em 0.75em; margin:0;"}
**RL4AA** — Reinforcement Learning for Autonomous Accelerators

Annual workshop + challenge · 2026 edition: **Liverpool**
Community hub: tutorials, datasets, open challenges

<a href="https://rl4aa.github.io/" style="color:#22d3ee; font-size:0.88em;">rl4aa.github.io</a>
:::

::: {.highlight-box style="flex:1; font-size:0.80em; padding:0.55em 0.75em; margin:0;"}
**AISSAI Hackathon** — AI for Particle Accelerators

Hands-on school + hackathon · **Oct 11–16 2026**
Organised at IN2P3 · open to students and researchers

<a href="https://indico.in2p3.fr/event/39704/" style="color:#22d3ee; font-size:0.88em;">indico.in2p3.fr/event/39704</a>
:::
:::
