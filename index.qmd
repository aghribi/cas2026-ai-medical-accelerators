...
<div style="display:flex; align-items:stretch; gap:0.2em; margin:0.7em 0 0.4em 0; width:100%;">
<div class="pipe-box" data-pipe="1" style="border-color:#475569; background:rgba(71,85,105,0.12); --pipe-glow:rgba(100,116,139,0.45);">
<div style="font-weight:700; font-size:0.80em; color:#64748b;">Raw Data</div>
<div style="font-size:0.68em; color:#475569; margin-top:0.2em;">Waveforms · images<br>logs · set-points</div>
</div>
<div class="pipe-arrow">→</div>
<div class="pipe-box" data-pipe="2" style="border-color:#3b82f6; background:rgba(59,130,246,0.10); --pipe-glow:rgba(59,130,246,0.45);">
<div style="font-weight:700; font-size:0.80em; color:#3b82f6;">Pre-process</div>
<div style="font-size:0.68em; color:#475569; margin-top:0.2em;">Clean · sync<br>normalise · resample</div>
</div>
<div class="pipe-arrow">→</div>
<div class="pipe-box" data-pipe="3" style="border-color:#6366f1; background:rgba(99,102,241,0.10); --pipe-glow:rgba(99,102,241,0.45);">
<div style="font-weight:700; font-size:0.80em; color:#6366f1;">Feature extract</div>
<div style="font-size:0.68em; color:#475569; margin-top:0.2em;">FFT · Gaussian fit<br>statistics · domain</div>
</div>
<div class="pipe-arrow">→</div>
<div class="pipe-box" data-pipe="4" style="border-color:#a78bfa; background:rgba(167,139,250,0.10); --pipe-glow:rgba(167,139,250,0.45);">
<div style="font-weight:700; font-size:0.80em; color:#a78bfa;">Train &amp; validate</div>
<div style="font-size:0.68em; color:#475569; margin-top:0.2em;">80/20 split<br>cross-val · AUC</div>
</div>
<div class="pipe-arrow">→</div>
<div class="pipe-box" data-pipe="5" style="border-color:#22d3ee; background:rgba(34,211,238,0.10); --pipe-glow:rgba(34,211,238,0.45);">
<div style="font-weight:700; font-size:0.80em; color:#22d3ee;">Deploy &amp; infer</div>
<div style="font-size:0.68em; color:#475569; margin-top:0.2em;">Sub-ms response<br>monitoring · retrain</div>
</div>
</div>

<div style="display:flex; gap:0.45em; margin-bottom:0.5em; width:100%;">
<div class="pipe-uc" data-pipe="5"><div class="pipe-uc-title">UC1 · Fault detection</div><div class="pipe-uc-desc">IQ → autoencoder → alarm</div></div>
<div class="pipe-uc" data-pipe="5"><div class="pipe-uc-title">UC2 · Beam tuning</div><div class="pipe-uc-desc">Quad → Cheetah → BO</div></div>
<div class="pipe-uc" data-pipe="5"><div class="pipe-uc-title">UC3 · Surrogate</div><div class="pipe-uc-desc">5k Cheetah → MLP → 586×</div></div>
</div>

<div style="display:grid; min-height:2.2em; margin-top:0.4em;">
<div class="fragment current-visible" data-pipe-highlight="1,2" data-fragment-index="1" style="grid-area:1/1; text-align:center; font-size:0.80em; color:#3b82f6; font-weight:600;">① Data quality &amp; preprocessing</div>
<div class="fragment current-visible" data-pipe-highlight="3"   data-fragment-index="2" style="grid-area:1/1; text-align:center; font-size:0.80em; color:#6366f1; font-weight:600;">② Feature engineering</div>
<div class="fragment current-visible" data-pipe-highlight="4"   data-fragment-index="3" style="grid-area:1/1; text-align:center; font-size:0.80em; color:#a78bfa; font-weight:600;">③ Model selection &amp; training</div>
<div class="fragment current-visible" data-pipe-highlight="5"   data-fragment-index="4" style="grid-area:1/1; text-align:center; font-size:0.80em; color:#22d3ee; font-weight:600;">④ Deploy &amp; use cases 1–3</div>
</div>

::: notes
Road-map slide. Step through the 4 highlights before diving into the content. Each fragment lights the section(s) you're about to teach.
:::
...
::: {.fragment .fade-in-then-semi-out style="border-left:3px solid rgba(34,211,238,0.5); padding:0.35em 0.7em; font-size:0.76em; margin-bottom:0.5em;" fragment-index="1"}
**⚗ Data scarcity** — faults rare, labels unavailable.
:::
...
::: {.fragment .fade-in-then-semi-out style="border-left:3px solid rgba(34,211,238,0.5); padding:0.35em 0.7em; font-size:0.76em;" fragment-index="4"}
**⚙ Real-time integration** — PyTorch into Varian / Elekta.
:::
...
<span style="font-size:1.6em; font-weight:800; color:#22d3ee; line-height:1.2;">Rare by design</span><br>
<span style="font-size:0.72em; color:#94a3b8; display:block; margin-top:0.4em;">&lt;0.1% fault rate · &lt;100 labelled examples</span>
:::
...
::: {.fragment .current-visible style="grid-area:1/1; text-align:center; padding:1.5em 0;" fragment-index="3"}
...
::: {.fragment .current-visible style="grid-area:1/1; text-align:center; padding:1.5em 0;" fragment-index="4"}
<span style="font-size:1.6em; font-weight:800; color:#22d3ee; line-height:1.2;">&lt;1 ms</span><br>
<span style="font-size:0.72em; color:#94a3b8; display:block; margin-top:0.4em;">RF loop latency · vendor certification ongoing</span>
:::
...
<div class="fragment slide-callout-overlay" data-fragment-index="5">
<div class="concept-callout-box">
