...
::: {.key-result style="margin-top: 0.4em; font-size:0.78em;"}
...
::: {.key-result style="margin-top: 0.2em; font-size:0.78em;"}
Good features = simpler models + better generalisation. Domain knowledge beats brute force.
:::
...
::: {.fragment .fade-in}
::: {.highlight-box #box-fault style="margin: 0.2em 0; padding: 0.3em 0.8em; font-size:0.85em;"}
**Fault detection** — classify anomalous events before interlocks trigger
:::
:::
::: {.fragment .fade-in}
::: {.highlight-box #box-tuning style="margin: 0.2em 0; padding: 0.3em 0.8em; font-size:0.85em;"}
**Beam tuning** — find optimal settings with minimal beam time (< 50 evaluations)
:::
:::
::: {.fragment .fade-in}
::: {.highlight-box #box-surrogate style="margin: 0.2em 0; padding: 0.3em 0.8em; font-size:0.85em;"}
**Surrogate models** — replace slow tracking codes (10³–10⁵× speedup)
:::
:::
::: {.fragment .fade-in}
::: {.highlight-box style="margin: 0.2em 0; padding: 0.3em 0.8em; font-size:0.85em;"}
