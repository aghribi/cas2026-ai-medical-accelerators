...
::: {.highlight-box style="margin-bottom:0.6em;"}
**Retrieval = descend in energy**

The network updates spins one-by-one:
...
For N neurons, up to ~0.14N patterns can be stored reliably.

Derived by **replica method** from statistical mechanics — not a CS result.
:::
...
fig.add_annotation(
    x=0.5, y=0.99, xref='paper', yref='paper',
...
fig.update_layout(
    ...
    paper_bgcolor='#0d1b2a', plot_bgcolor='#111f30',
    font=dict(color='#e2e8f0', size=11),
    legend=dict(bgcolor='rgba(0,0,0,0)', font=dict(size=10), x=0.02, y=0.92),
...
fig.update_layout(height=460, autosize=True,
    ...
    paper_bgcolor="#0d1b2a", plot_bgcolor="#111f30",
    font=dict(color="#e2e8f0", size=11),
    legend=dict(bgcolor="rgba(0,0,0,0)", orientation="h", y=0.98, x=0.5, xanchor="center"),
...
fig.update_layout(height=380, autosize=True, paper_bgcolor="#0d1b2a", plot_bgcolor="#111f30",
    font=dict(color="#e2e8f0", size=11), margin=dict(l=40,r=10,t=8,b=25))
fig
```
