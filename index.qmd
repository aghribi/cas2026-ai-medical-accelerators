...
::: {.highlight-box style="margin-bottom:0.4em; font-size:0.75em;"}
...
::: {.key-result .fragment style="font-size:0.75em;"}
...
## {background-color="#0a1a2a" .no-footer}

::: {style="display:flex; align-items:center; justify-content:center; min-height:580px;"}
<div class="callout-box" style="max-width:62%; font-size:1.05em;">
...
## {background-color="#140c00" .no-footer}
...
::: {.highlight-box style="margin-bottom: 0.5em; font-size:0.85em;"}
**Foundation models for accelerators**

Large pretrained models fine-tuned on machine data — enable cross-facility transfer without retraining from scratch.
:::

::: {.highlight-box style="margin-bottom: 0.5em; font-size:0.85em;"}
**Physics-Informed Neural Networks (PINNs)**

Embed beam dynamics equations directly into the loss function — physics constraints respected even far from training data.
:::

::: {.highlight-box style="font-size:0.85em;"}
**Transformers for time-series control**

Attention captures long-range patterns in beam signals — strong performance on non-stationary, correlated sequences.
:::
...
::: {.highlight-box style="margin-bottom: 0.5em; font-size:0.85em;"}
**Reinforcement learning — closed-loop autonomy**

Policy learned directly in the control loop. Demonstrated at ESRF, SNS, and proton therapy facilities. Adaptive QA is next.
:::

::: {.highlight-box style="margin-bottom: 0.5em; font-size:0.85em;"}
**Generative models — solving data scarcity**

VAEs and diffusion models synthesise realistic fault waveforms for training — directly addresses the clinical-machine bottleneck.
:::

::: {.key-result style="font-size:0.82em;"}
These build directly on everything covered today.
The field is moving fast — the foundations you have are the right ones.
:::
...
::: notes
This is an appetizer, not a full menu. Foundation models (e.g. CERN's accelerator-specific LLM prototypes), PINNs (several groups at SNS and ESS), and RL (Emma+2018, Kain+2020, Hirlaender+2020) are all active research directions with published results. The key message: the gap between today's lecture and the frontier is smaller than students often assume.
:::
