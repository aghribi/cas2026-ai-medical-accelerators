...
<img src="assets/portrait_pitts.png" style="float:right; margin: 0 0 0.3em 0.8em; border-radius:6px; border:1px solid rgba(34,211,238,0.4); width:75px;">

**Warren McCulloch** (neuroscientist) & **Walter Pitts** (logician) — 1943 — first mathematical model of a neuron, mapping neural activity onto Boolean logic.

<div style="clear:both;"></div>

<img src="assets/mcculloch_pitts_neuron.png" style="width:100%; max-height:64vh; object-fit:contain; border-radius:6px; margin-top:0.1em;">
